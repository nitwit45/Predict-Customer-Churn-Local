# This code runs, the models are trained and the figures are also generated correctly, we would have to edit the code so that the user gets a better visual,
# output of whats happening in the program. Also it would be better if we can add this to a google colab/jupyter notebook. Google colab would be easier...
...
def encoder_helper(dataframe, category_lst, response=None):
    ...
    print("Categorical Features Encoding Completed.")
    return dataframe
